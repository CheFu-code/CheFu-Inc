            ...
            <div className="mx-auto max-w-7xl">
                ...
                <section aria-labelledby="product-grid-heading" className="mt-16">
                    <div className="mb-8 flex items-end justify-between gap-6">
                        <div>
                            <h2 id="product-grid-heading" className="text-2xl font-bold text-slate-900 md:text-3xl">
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        {companyProducts.map((product) => (
                            <article key={product.name} className="group overflow-hidden rounded-2xl border border-slate-200 bg-white transition-colors hover:border-cyan-400/60 hover:shadow-sm">
                                ...
                                <div className="p-6 md:p-8">
                                    <p className="text-xs font-semibold uppercase tracking-[0.16em] text-cyan-700">{product.category}</p>
                                    <h3 className="mt-3 text-2xl font-bold text-slate-900">{product.name}</h3>
                                    <p className="mt-3 leading-7 text-slate-600">{product.description}</p>
                                    <a href={product.href} target="_blank" rel="noreferrer" className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-slate-900 hover:text-cyan-700">
                ...
                <section aria-labelledby="product-engineering-heading" className="mt-20 border-t border-slate-200 pt-12">
                    <div className="flex max-w-3xl items-start gap-4">
                        ...
                        <div>
                            <h2 id="product-engineering-heading" className="text-2xl font-bold text-slate-900">From product idea to production system.</h2>
                            ...
                            <Link href="/contact?service=Digital%20Product" className="mt-5 inline-flex items-center gap-2 font-semibold text-cyan-700 hover:text-cyan-600">
