...
import { Users, Target, Zap, Shield, Globe, Award, Music, Cpu } from 'lucide-react';
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            We Are The Architects of <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-violet-500">Digital Sound & Logic</span>
          </h1>
        ...
        <div className="mb-24">
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { name: "Alex Chen", role: "CEO & Chief Architect", icon: Globe },
        ...
        {/* CTA */}
        <div className="text-center bg-gradient-to-br from-slate-900 to-slate-950 p-12 rounded-3xl border border-slate-800">
