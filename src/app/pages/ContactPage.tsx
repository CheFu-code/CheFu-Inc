...
export function ContactPage() {
  ...
  useEffect(() => {
    ...
    if (service) {
      ...
      } else if (service.includes('Software') || service.includes('Web') || service.includes('App')) {
    ...
    <div className="pt-32 pb-20 bg-slate-950 min-h-screen">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Start a Project</h1>
          <p className="text-xl text-slate-400">
            Ready to bring your vision to life? Fill out the form below and let's discuss how we can help.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <div className="space-y-12">
              ...
              <div className="space-y-6">
                 <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">123 Innovation Blvd, Suite 400<br/>Tech City, TC 90210</p>
                    </div>
                 </div>
            ...
            <div className="bg-gradient-to-br from-violet-900/20 to-cyan-900/20 p-8 rounded-2xl border border-slate-800">
              <h3 className="text-lg font-bold text-white mb-2">Not sure what you need?</h3>
              <p className="text-slate-400 mb-4">
                Schedule a free 15-minute consultation call with one of our specialists.
              </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  {errors.projectType && <span className="text-red-400 text-xs">{errors.projectType.message}</span>}
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-300">Estimated Budget</label>
                  <select
                    {...register("budget")}
                    className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-cyan-500 transition-colors appearance-none"
                  >
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-cyan-500 to-violet-600 text-white font-bold rounded-lg hover:shadow-lg hover:shadow-cyan-500/20 transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
